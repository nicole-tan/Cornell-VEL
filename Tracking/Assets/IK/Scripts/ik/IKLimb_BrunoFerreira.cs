...
public class IKLimb: MonoBehaviour {
	...
	//start, joint, and end are wrist, elbow, shoulder aka hand, forearm, and upperarm 
	//Bruno => IK => Implementation 
	//hand = start = wrist; forearm = joint = elbow; upperarm = end = shoulder 
	public Transform upperArm, forearm, hand;
	//elbowTarget is equivalent of poleVector
	public Transform target, elbowTarget;
	
	public bool IsEnabled, debug;

	//equivalent of blendPct in SteamVR
	...
	void CalculateIK(){
		...
		//The line causing trouble is the following one 
		//end.transform.LookAt(joint.position, end.up);
