...
public class DuplicateSelf : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("createNewBubbles", 2, lifetime);
    ...
    void createNewBubbles()
    {
        ...
        newObj.tag = "bubble";
        newObj.GetComponent<Rigidbody>().useGravity = false;
        //if (bubbleDimensions != null) {
        //    newObj.transform.localScale = new Vector3 (bubbleDimensions/10, bubbleDimensions/10, bubbleDimensions/10); 
        //} 
